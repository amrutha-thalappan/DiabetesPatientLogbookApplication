...
public class ForgotpasswordApiController implements ForgotpasswordApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(ForgotpasswordApiController.class);
    ...
    public ResponseEntity<Void> forgotpasswordPost(@DecimalMin("1")@ApiParam(value = "The email ID of the user to recieve password update mail.",required=true) @PathVariable("email") String email
) {
